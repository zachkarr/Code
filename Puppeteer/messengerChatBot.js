...
( async () =>
{
    ...
    let oldemoji = await page.evaluate( () =>
    {
        return Array.from( document.querySelectorAll( '.x11i5rnm.xat24cr.x1mh8g0r.x1vvkbs.xdj266r' ) ).map( ( el ) => el.children.item( 0 ).children.item( 0 ).alt );
    } );

    console.log( "theOldEmoji", oldemoji );
    setInterval( async function ()
    {
        ...
        let newemoji = await page.evaluate( () =>
        {
            return Array.from( document.querySelectorAll( '.x11i5rnm.xat24cr.x1mh8g0r.x1vvkbs.xdj266r' ) ).map( ( el ) => el.children.item( 0 ).children.item( 0 ).alt );
        } );

        console.log( "theNewEmoji", newemoji );
